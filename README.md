# What Fits? — Android RU prototype v0.0.9
...
- многообластное OCR: весь кадр и четыре перекрывающихся увеличенных фрагмента с усилением контраста;
...
Для командной сборки нужны JDK 17, Android SDK Platform 36 и Build Tools 36.1.0. Версию Gradle 9.4.1 загрузит проектный Wrapper с проверкой SHA-256. Готовый файл появится в `android/app/build/outputs/apk/debug/app-debug.apk`. CI сохраняет его как артефакт `what-fits-v0.0.9-debug` на 14 дней.
